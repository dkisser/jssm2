...
<!-- 	    							<a href="javascript:void(0);" id="addPicBtn" title="添加图片" class="easyui-tooltip" ></a> -->
	...
	var mlzlOpt = {
		...
		addPicDialogInit : function(title){
			...
			$("#addPicDialog").dialog("open").dialog("refresh","${pageContext.servletContext.contextPath }/ajuan/ajzlAddPicUI.do");
		},
		...
		doDeletePic : function(nodeIds){
			...
			$.messager.progress();
			$.ajax({
				url: "${pageContext.servletContext.contextPath}/ajuan/lsAjzlDeletePic.do",
				async:true,		//是否异步请求
				cache:false,	//是否缓存
				type:"post",	//请求方式
