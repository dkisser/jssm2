...
public class AjjyOuterHistoryParam {
	...
	public void setZjhm(String zjhm) {
		this.zjhm = zjhm.trim().length() == 0 ? null : zjhm;
	}
	...
	public void setRylx(String rylx) {
		this.rylx = rylx.trim().length() == 0 ? null : rylx;
	}
	...
	public void setDjdn(String djdn) {
		this.djdn = djdn.trim().length() == 0 ? null : djdn;
	}
	...
	public void setZjlx(String zjlx) {
		this.zjlx = zjlx.trim().length() == 0 ? null : zjlx;
	}
	...
	public void setGzdw(String gzdw) {
		this.gzdw = gzdw.trim().length() == 0 ? null : gzdw;
	}
	...
	public void setUid(String uid) {
		this.uid = uid.trim().length() == 0 ? null : uid;
	}
